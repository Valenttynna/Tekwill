...
//with a Scanner and one more integer to find the position of
        //Don’t use imports in this exercise
...
//pass the given parameters in the same order to this method
        java.util.Arrays.sort(arr);

//Use binarySearch method to find its position in the array
